          ...
          <div class="col-lg-8">
            <div class="card-group d-block d-md-flex row">
              <div class="card col-md-7 p-4 mb-0">
                ...
                <img src="<?= APPURL."/assets/img/logo2.png?v=".VERSION ?>" 
            ...
            <!-- END LOGIN -->
              ...
              <div class="card col-md-5 text-white bg-primary py-5">
                <div class="card-body text-center">
                  <div>
                    <h2>Đăng ký mới</h2>
                    <p>Bạn muốn trở thành bác sĩ của LeeHa Medical với mạng lưới khắp thế giới. Còn chần chừ gì nữa đăng kí tài khoản ngay nào !</p>
