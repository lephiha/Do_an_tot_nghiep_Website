                                ...
                                <tr data-id="1" class="align-middle">
                                    <td class="text-center" id="id">
                                        <div class="avatar avatar-md">
                                            <img class="avatar-img" src="http://127.0.0.1:8081/Do_an_tot_nghiep_lph/API/assets/uploads/avatar_doctor_1_1669026326.jpg" alt="avatar">
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="fw-semibold" id="email">phihasky@gmail.com</div>
                                    </td>
